...
(function (TcHmi) {
    let Controls;
    (function (Controls) {
        let TcHmiTextboxExtended;
        (function (TcHmiTextboxExtended) {
            class TcHmiTextboxExtendedControl extends TcHmi.Controls.Beckhoff.TcHmiTextbox {
                ...
                */
                 ...
                 */
                __processText() {
                    if (void 0 === this.__text)
                        return;
                    if (!this.__elementInputField || 0 === this.__elementInputField.length)
                        return;
                    // @ts-ignore
            ...
            TcHmiTextboxExtended.TcHmiTextboxExtendedControl = TcHmiTextboxExtendedControl;
        })(TcHmiTextboxExtended = Controls.TcHmiTextboxExtended || (Controls.TcHmiTextboxExtended = {}));
...
//# sourceMappingURL=TcHmiTextboxExtendedControl.js.map